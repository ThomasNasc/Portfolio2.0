...
import AnimatedCicle from "./AnimatedCicle/AnimatedCicle";
...
function ScrollerMenu(props) {
  ...
  const proportionTotationMenu = scrollAmount / screenSize.height;
  const propsMenu = {
    size: 700,
    maxDeg: 180,
    initialDeg: 60 - 500 * proportionTotationMenu,
    miniItems: [
      {
        icon: (
