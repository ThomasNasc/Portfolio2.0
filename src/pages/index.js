...
export default function Home() {
  const refAbout = useRef(0);
  const refProjects = useRef(0);
  const refContact = useRef(0);

  const Yposition =() => [
    refAbout.current.offsetTop,
    refProjects.current.offsetTop,
    refContact.current.offsetTop,
  ];
  ...
  return (
    <div className="main">
      <div className="page-initial-about">
        <div className="page-menu-about">
          <div className=" page-menu">
            <ScrollerMenu Yposition={Yposition} />
          </div>
          <div className=" page-about " ref={refAbout}>
            <About />
          </div>
        </div>
      ...
      <span ref={refProjects}></span>
      <Projects />
      <div className="page page-contact " ref={refContact}>
